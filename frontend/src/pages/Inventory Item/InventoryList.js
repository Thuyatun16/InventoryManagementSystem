...
const InventoryList = () => {
    ...
    const fetchCategories = () => {
        axios.get('http://localhost:5000/categories') // Adjust this endpoint if necessary
            .then((response) => {
                    ...
                    <li key={item.id || item.name} className="inventory-item">
                        {isEditing === item.id ? (
                            ...
                            <>
                                ...
                                >
                                    <span className="inventory horrors-item-name">{item.name}</span>
                               ...
                               {isAdmin&&( <div className="inventory-item-buttons">
                                    <button
                                        onClick={() => handleEditItem(item.id)}
